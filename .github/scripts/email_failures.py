...
def main():
    ...
    all_workflows = {
        "addons_frontend": ["flodolo"],
        "addons_server": ["flodolo"],
        "firefox_android": ["cpedraza", "flodolo"],
        "firefox_ios": ["cpedraza", "flodolo"],
        "firefoxcom": ["flodolo"],
        "focus_android": ["cpedraza", "flodolo"],
        "focus_ios": ["cpedraza", "flodolo"],
        "fxa_cms": ["bolsson"],
        "fxa_gettext": ["bolsson"],
        "fxa": ["bolsson"],
        "mac": ["flodolo"],
